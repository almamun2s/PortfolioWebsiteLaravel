...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Permissions</h1>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.permissions.store') }}" method="post">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Portfolio"
                                        autocomplete="off">
                                    @error('name')
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8">
                                    <input type="submit" class="btn btn-primary" value="Add Permissions">
                                </div>
                            </div>
                        </form>
